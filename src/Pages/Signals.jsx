...
const signalsData = [
  {
    ...
    title: "SKINYZ",
    text: "La pista tiembla cuando se pone detrás de los decks.",
  },
  {
    id: 2,
    image: "/images/signals/signals_2.png",
    title: "LITO",
    text: "Ahora estoy con mis dogs bounce bouncing, finde de Saturnight yeh' y entre semana working.",
  },
  {
    id: 3,
    image: "/images/signals/signals_3.png",
    title: "SOFÍA GABANNA",
    text: "Me manejo como quiero en esto que decís que yo no merezco, pero tengo desde que nací.",
  },
  {
    id: 4,
    image: "/images/signals/signals_4.png",
    title: "MANEL DART",
    text: "Manel Hago Cosas: ruido, calle y cero filtros.",
  },
  {
    id: 5,
